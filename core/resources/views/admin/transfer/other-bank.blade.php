                                        ...
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    @if($val->status==0)
                                                        <a class='dropdown-item' href="{{url('/')}}/admin/app-otherbank/{{$val->id}}"><i class="icon-thumbs-up3 mr-2"></i>Approve</a>
                                                    @endif
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a  href="{{url('/')}}/admin/other-bank/delete/{{$val->id}}" class="btn bg-danger">Proceed</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
